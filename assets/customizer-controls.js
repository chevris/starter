...
/***/ "./inc/classes/customizer/controls/src/customizer-controls/multi-select/MultiSelect.js":
/*!*********************************************************************************************!*\
  !*** ./inc/classes/customizer/controls/src/customizer-controls/multi-select/MultiSelect.js ***!
  \*********************************************************************************************/
...
var MultiSelect = function MultiSelect(_ref) {
  var choices = _ref.choices,
      reset_values = _ref.reset_values,
      onChange = _ref.onChange,
      currentValue = _ref.currentValue,
      label = _ref.label;

  var Pill = function Pill(_ref2) {
    var slug = _ref2.slug,
        _ref2$isRemove = _ref2.isRemove,
        isRemove = _ref2$isRemove === void 0 ? false : _ref2$isRemove;
    var buttonIcon = isRemove ? _wordpress_icons__WEBPACK_IMPORTED_MODULE_2__["cancelCircleFilled"] : _wordpress_icons__WEBPACK_IMPORTED_MODULE_2__["plusCircleFilled"];
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Tooltip"], {
      key: slug,
      text: isRemove ? Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Remove Item', 'themeslug') : Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Add item', 'themeslug')
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("button", {
      type: "button",
      className: "token",
      onClick: function onClick() {
        var newVal = isRemove ? _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(currentValue).filter(function (v) {
          return v !== slug;
        }) // Return array of values minus this pill slug
        : [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(currentValue), [slug]); // Add this pill slug to selected values

        onChange(newVal);
      }
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", {
      className: "title"
    }, choices[slug]), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Icon"], {
      icon: buttonIcon,
      size: 18
    })));
  };
  ...
  var Reset = function Reset() {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__["Tooltip"], {
      text: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Default values', 'themeslug')
  ...
  var addable = Object.keys(choices).filter(function (choice) {
    return !currentValue.includes(choice);
  }) // Return array of available choices that are not selected
  .map(function (slug, i) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(Pill, {
      key: i,
      slug: slug
    });
  });
  var values = currentValue.filter(function (slug) {
    return choices[slug];
  }).map(function (slug, i) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(Pill, {
      key: i,
  ...
  }); // Return array of Pill components for each selected value

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "themeslug-multiselect"
  ...
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(Reset, null))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "selected-options"
  }, values.length ? values : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", {
    className: "placeholder"
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Add items by clicking the ones below.', 'themeslug'))), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    className: "available-options"
  }, addable.length > 0 ? addable : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", {
    className: "placeholder"
  }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('All items are already selected.', 'themeslug'))));
};

MultiSelect.propTypes = {
  choices: prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.object.isRequired,
  onChange: prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.func.isRequired,
  currentValue: prop_types__WEBPACK_IMPORTED_MODULE_5___default.a.array.isRequired,
...
/***/ "./inc/classes/customizer/controls/src/customizer-controls/multi-select/MultiSelectComponent.js":
/*!******************************************************************************************************!*\
  !*** ./inc/classes/customizer/controls/src/customizer-controls/multi-select/MultiSelectComponent.js ***!
  \******************************************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _MultiSelect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MultiSelect */ "./inc/classes/customizer/controls/src/customizer-controls/multi-select/MultiSelect.js");
...
var MultiSelectComponent = function MultiSelectComponent(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_MultiSelect__WEBPACK_IMPORTED_MODULE_2__["default"], {
    label: label,
    choices: choices,
...
/* harmony default export */ __webpack_exports__["default"] = (MultiSelectComponent);

/***/ }),

/***/ "./inc/classes/customizer/controls/src/customizer-controls/multi-select/control.js":
/*!*****************************************************************************************!*\
  !*** ./inc/classes/customizer/controls/src/customizer-controls/multi-select/control.js ***!
  \*****************************************************************************************/
...
/* harmony import */ var _MultiSelectComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MultiSelectComponent */ "./inc/classes/customizer/controls/src/customizer-controls/multi-select/MultiSelectComponent.js");
...
var MultiSelectControl = wp.customize.Control.extend({
  renderContent: function renderContent() {
    var control = this;
    Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["render"])(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_MultiSelectComponent__WEBPACK_IMPORTED_MODULE_1__["default"], {
      control: control
    }), control.container[0]);
  }
});
...
/* harmony import */ var _customizer_controls_multi_select_control__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./customizer-controls/multi-select/control */ "./inc/classes/customizer/controls/src/customizer-controls/multi-select/control.js");
/* harmony import */ var _customizer_controls_react_multi_select_control__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./customizer-controls/react-multi-select/control */ "./inc/classes/customizer/controls/src/customizer-controls/react-multi-select/control.js");
/* harmony import */ var _customizer_controls_page_visibility_control__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./customizer-controls/page-visibility/control */ "./inc/classes/customizer/controls/src/customizer-controls/page-visibility/control.js");
/* global wp */
...
wp.customize.controlConstructor.theme_slug_multi_select_control = _customizer_controls_multi_select_control__WEBPACK_IMPORTED_MODULE_3__["MultiSelectControl"];
wp.customize.controlConstructor.theme_slug_react_multi_select_control = _customizer_controls_react_multi_select_control__WEBPACK_IMPORTED_MODULE_4__["ReactMultiSelectControl"];
wp.customize.controlConstructor.theme_slug_page_visibility_control = _customizer_controls_page_visibility_control__WEBPACK_IMPORTED_MODULE_5__["PageVisibilityControl"]; // wp.customize.controlConstructor.theme_slug_icon_checkbox_control = IconCheckboxControl;
